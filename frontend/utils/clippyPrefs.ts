...
> = {
  sm: {
    ...
    bubbleMaxW: 'max-w-[min(240px,calc(100vw-5rem))]',
    bubbleMinW: 'min-w-[140px]',
    body: 'text-[10.5px]',
    cursor: 'h-[10px]',
    meta: 'text-[8px]',
  ...
  md: {
    ...
    bubbleMaxW: 'max-w-[min(300px,calc(100vw-5rem))]',
    bubbleMinW: 'min-w-[160px] sm:min-w-[200px]',
    body: 'text-[12.5px]',
    cursor: 'h-[12px]',
    meta: 'text-[10px]',
  ...
  lg: {
    ...
    bubbleMaxW: 'max-w-[min(360px,calc(100vw-5rem))]',
    bubbleMinW: 'min-w-[200px] sm:min-w-[240px]',
    body: 'text-[15px]',
    cursor: 'h-[14px]',
    meta: 'text-[11px]',
